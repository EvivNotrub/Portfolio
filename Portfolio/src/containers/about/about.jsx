    ...
    <div data-testid="about-testid" className="about">
      ...
      <article className="about__article">
        ...
        <p className="about__text">
          ...
          of now, advertising some projects that are part of this degree. They
          are made for the sole purpose of learning new skills and technologies,
          each one with a specific topic. A description of the project provides
          context and the goals we had, since not all of them were made from
          scratch. This allows you to understand what was implemented by myself
          or not.
        </p>
        <p className="about__text">
